...
package com.coinbase.zxing.client.android.common;
 ...
 *
 * <p>It is necessary to only load classes that use newer APIs than the device may support after
 * the
 * app
 * has checked the API level. This requires reflection, loading one of several implementations
 * based
 * on the
 * API level.</p>
 *
 ...
 *
 * <p>At runtime an appropriate implementation is then chosen, instantiated and returned from
 * {@link
 * #build()}.</p>
 *
