 ...
 */
public class AccountSQLiteOpenHelperCallbacks {

    private static final String TAG = AccountSQLiteOpenHelperCallbacks.class.getSimpleName();
    ...
    public void onUpgrade(final Context context, final SQLiteDatabase db, final int oldVersion,
        ...
        //  new AccountSQLiteUpgradeHelper().onUpgrade(db, oldVersion, newVersion);
    }
}
