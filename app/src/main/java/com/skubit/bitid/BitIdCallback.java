...
import com.skubit.dialog.ProgressCallback;
import com.skubit.shared.dto.BitJwtCallbackResponseDto;

public interface BitIdCallback extends ProgressCallback {
    ...
    void showSignInResponse(BitJwtCallbackResponseDto data, String bitID);
